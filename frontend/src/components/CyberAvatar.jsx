...
/**
 * Host Avatar: Grand Gothic Arch-Commander Emblem (Esports / RPG Avatar style)
 */
export function HostAvatar({ className = "w-28 h-28" }) {
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      ...
      {/* Grand Arch-Commander Gothic Emblem */}
      <svg viewBox="0 0 120 120" className="w-full h-full relative z-10 drop-shadow-[0_0_18px_rgba(168,85,247,0.9)]">
        ...
        {/* Main Gothic Blackened Steel Helm */}
...
/**
 * Esports-Style Gothic Warrior Badges for Players
 */
const WARRIOR_BADGES = [
  // 1. Gothic Sallet Knight (Steel / Cyan)
  {
  ...
  // 2. Crusader Templar Paladin (White / Gold / Red Cross)
  {
    ...
    render: () => (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        {/* Cruciform Brass Reinforcement Plate */}
  ...
  // 3. Shadow Rogue Assassin (Hooded Cowl / Violet)
  {
  ...
  // 4. Viking Warlord Jarl (Iron / Horned / Amber Beard)
  {
    name: "Viking Warlord",
  ...
  // 5. Crimson Dragon Slayer (Gothic Spiked / Rose)
  {
    name: "Crimson Knight",
  ...
  // 6. Valkyrie Shieldmaiden (Winged Tiara / Emerald)
  {
    ...
    render: () => (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        {/* Silver Circlet with Emerald Gem */}
